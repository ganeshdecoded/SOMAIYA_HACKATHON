...
import com.example.medicinereminder.databinding.ActivityMainWorkoutBinding
import sszj.s.geminiapi.ui.GeminiChatBotActivity

class MainActivityWorkout : AppCompatActivity() {

    private var binding: ActivityMainWorkoutBinding? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainWorkoutBinding.inflate(layoutInflater)
